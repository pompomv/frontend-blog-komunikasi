...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl font-extrabold text-gray-950 tracking-tight sm:text-6xl mb-6">
            How to Write <span className="text-blue-600">Effective</span><br /> Business Communication.
          </h1>
        ...
        <div className="w-full bg-white overflow-hidden leading-none">
      ...
      <div className="relative pt-24 pb-0 bg-slate-900 overflow-hidden">
        {/* Background decorative elements */}
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-slate-800 rounded-full mix-blend-multiply filter blur-3xl opacity-50"></div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="text-slate-300 text-lg leading-relaxed space-y-6">
              <p>
                <strong className="text-white">Written business communication</strong> is the process of delivering information, instructions, or decisions in written form within a workplace or organizational setting. It spans <em className="text-blue-300">emails, memos, formal letters,</em> and <em className="text-blue-300">meeting minutes</em> — each serving a distinct purpose in the professional world.
              </p>
              <p>
              ...
              <p className="text-white font-semibold text-lg border-l-4 border-blue-500 pl-5 py-2 bg-blue-500/5 rounded-r-lg">
            ...
            <div className="bg-slate-800/50 backdrop-blur-lg rounded-3xl p-8 md:p-10 border border-slate-700 shadow-2xl relative group hover:-translate-y-2 transition-transform duration-500">
              ...
              <div className="relative">
                <svg className="w-12 h-12 text-blue-400 mb-6 opacity-80" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-tr from-blue-400 to-indigo-500 flex items-center justify-center text-white font-bold text-xl shadow-lg ring-4 ring-slate-800">
                    KB
                  </div>
                  <div>
                    <div className="text-white font-bold">KombisBlog Editorial</div>
                    <div className="text-blue-400 text-sm">Business Communication Specialists</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-20 grid grid-cols-1 sm:grid-cols-3 gap-6 mb-20">
            {[
              ...
              <div key={pillar.label} className="bg-slate-800/60 border border-slate-700 rounded-2xl p-6 flex flex-col gap-3 hover:border-blue-500/50 hover:bg-slate-800 transition-all duration-300">
                <span className="text-3xl">{pillar.icon}</span>
                <h4 className="text-white font-bold text-lg">{pillar.label}</h4>
          ...
          <div className="text-center">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-6">Ready to elevate your professional writing?</h3>
        ...
        <div className="w-full bg-white overflow-hidden leading-none">
          <svg viewBox="0 0 1440 80" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" className="w-full block" style={{height:'80px'}}>
            <rect width="1440" height="80" fill="white"/>
            <path d="M0,80 C360,0 1080,0 1440,80 L1440,0 L0,0 Z" fill="#0f172a" />
          </svg>
        </div>
      </div>
      {/* Grid Section - Menampilkan data dari API */}
      <div className="bg-gradient-to-b from-white via-gray-50/60 to-white">
        <div className="text-center mb-16">   
          <span className="text-blue-400 font-bold tracking-widest uppercase text-sm mb-4 block">
            Core Curriculum
          </span>
          <h2 className="text-4xl md:text-5xl font-extrabold text-blue-600 mb-8 leading-tight">
      ...
      <div className="bg-slate-900 overflow-hidden leading-none">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            {([
              ...
              <details
                key={i}
                className="group bg-slate-800/60 border border-slate-700 rounded-xl overflow-hidden hover:border-blue-500/40 transition-colors duration-200"
              >
                <summary className="flex items-center justify-between gap-4 px-6 py-4 cursor-pointer list-none select-none">
                  ...
                  <span className="flex-shrink-0 w-6 h-6 rounded-full border border-slate-600 flex items-center justify-center text-slate-400 group-open:border-blue-500 group-open:text-blue-400 text-base font-light transition-colors duration-200">
                    +
                  </span>
                </summary>
                <div className="px-6 pb-5 pt-2 text-slate-400 text-sm leading-relaxed border-t border-slate-800/60">
                  {item.a}
                </div>
              </details>
            ))}
